<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="CorporateBanking.Web35.LoginPage" %>

<asp:Content ID="LoginContent" ContentPlaceHolderID="MainContent" runat="server">
    <!-- ASP.NET Login Form (3.5) -->
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="button" id="btnLogin" value="Login" class="formButton" onclick="javascript:window.location.href='/CorporateBanking.Web35/dashboard.aspx';" />
            </td>
        </tr>
    </table>
    <br>
